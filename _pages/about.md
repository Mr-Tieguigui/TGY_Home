...
**Guiyao Tie** is a researcher focusing on **LLM evaluation, reasoning capability analysis, post-training optimization, and LLM agent security**. His recent work covers **self-correction benchmarks, prompt injection attacks, agent risk assessment and defense, and multimodal agent safety**. He is interested in the full research pipeline from fundamental capability analysis to security-oriented deployment in real systems.
...
Annual Meeting of the Association for Computational Linguistics (ACL Main Conference)

- Category: CCF A Conference
- Role: Co-author
- Image path: `images/papers/learnercompass.png`
</div>
</div>
...
- Image path: `images/papers/safeagent.png`
</div>
</div>
...
- Role: First author
- Image path: `images/papers/masking-watermarking-cooperative.png`
</div>
</div>
...
- Category: CCF A Conference
- Role: First author
- Image path: `images/papers/self-correction-benchmark.png`
</div>
</div>
...
- Category: CCF A Conference
- Role: Co-first author
- Image path: `images/papers/badvla.png`
</div>
</div>
...
- Category: CCF A Conference
- Role: Co-first author
- Image path: `images/papers/prompt-injection-tool-selection.png`
</div>
</div>
...
The 19th Challenge Cup National Extracurricular Academic and Technological Works Competition, Special Competition for Open Bidding and Leadership Assignment
...
The 7th Beijing Academy of Artificial Intelligence Conference, InnoVibe Co-Creation Session
